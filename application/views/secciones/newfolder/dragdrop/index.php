...
<head>
	...
	<!-- Styles -->
	<link href="./application\views\secciones/newfolder/css/jquery.filer.css" rel="stylesheet">
	<link href="./application\views\secciones/newfolder/css/themes/jquery.filer-dragdropbox-theme.css" rel="stylesheet">

	<!-- Jvascript -->
	<script src="http://code.jquery.com/jquery-3.1.0.min.js" crossorigin="anonymous"></script>
	<script src="./application\views\secciones/newfolder/js/jquery.filer.min.js" type="text/javascript"></script>
	<script src="./application\views\secciones/newfolder/dragdrop/js/custom.js" type="text/javascript"></script>
